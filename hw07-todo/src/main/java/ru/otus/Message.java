...
public class Message {
    ...
    private Message(long id, String field1, String field2, String field3, String field4,
        ...
        final var defensiveCopy = new ObjectForMessage();
        defensiveCopy.setData(List.copyOf(field13.getData()));
        this.field13 = defensiveCopy;
    }
    ...
    public ObjectForMessage getField13() {
        // list contained in ObjectForMessage referred by field13 is immutable,
        // so can return shallow copy
        final var shallowCopy = new ObjectForMessage();
        shallowCopy.setData(field13.getData());
        return shallowCopy;
    }
